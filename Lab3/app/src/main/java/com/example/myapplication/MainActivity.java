...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView tv_text, tv_name, tv_winner, tv_mmora, tv_cmore;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_cmore = findViewById(R.id.textView5);
        btn_scissor = findViewById(R.id.radioButton4);
        btn_stone = findViewById(R.id.radioButton5);
        btn_paper = findViewById(R.id.radioButton6);
            ...
            public void onClick(View v) {
                if(ed_name.length()<1)
                    ...
                    if((btn_scissor.isChecked() && computer==2) ||
                        ...
                        tv_winner.setText("勝利者\n電腦");
                        tv_text.setText("可惜，電腦獲勝了!再試一次吧");
                    }
                   else{
                        tv_winner.setText("勝利者\n平手");
